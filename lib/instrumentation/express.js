...
let instrumentExpress = function(express, opts = {}) {
  ...
  if (opts.httpTraceParserHook) {
    if (typeof opts.httpTraceParserHook === "string" || typeof opts.httpTraceParserHook === "function") {
      userContext = opts.userContext;
    } else {
      debug(
        "httpTraceParserHook option must either be an array of field names or a function returning an object"
      );
    }
  }
